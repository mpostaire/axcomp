...
void session_init(char *display) {
    ...
    s.window_types.type = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE", False);
    s.window_types.desktop = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_DESKTOP", False);
    s.window_types.dock = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_DOCK", False);
    s.window_types.toolbar = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_TOOLBAR", False);
    s.window_types.menu = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_MENU", False);
    s.window_types.util = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_UTILITY", False);
    s.window_types.splash = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_SPLASH", False);
    s.window_types.dialog = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_DIALOG", False);
    s.window_types.normal = XInternAtom(s.dpy, "_NET_WM_WINDOW_TYPE_NORMAL", False);
